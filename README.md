...
Lembre-se de ajustar os caminhos e URLs nos arquivos `backend/core/config.py` e `upload.html` na branch `versao-servidor` conforme necessário para o ambiente de produção.
